...
execute if score #get_inventory.slot rukky-func matches 12 store success score #get_inventory.success rukky-func run data modify storage rukky-func get_inventory.data set from entity @s Inventory[{Slot:12b}]
