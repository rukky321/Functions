...
execute if score #get_inventory.slot rukky-func matches 26 store success score #get_inventory.exist_data rukky-func run data modify storage rukky-func get_inventory.data set from entity @s Inventory[{Slot:26b}]
